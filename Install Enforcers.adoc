...
Use the flaw `--dynamic-tags-sync-interval` to configure the amount of time that an Enforcer will wait before pulling data. Default is 15 minutes. Setting this value to 0, disables the feature