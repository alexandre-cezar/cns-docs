...
For additional details about Connection Exceptions, please red this https://github.com/alexandre-cezar/cns-docs/blob/main/Monitor.adoc#connection-exceptions[page]
