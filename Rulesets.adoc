...
image::images/rulesets11.png[width=500,align="center"]
...
image::images/rulesets12.png[width=500,align="center"]
...
image::images/rulesets13.png[width=500,align="center"]
...
image::images/rulesets14.png[width=500,align="center"]
...
image::images/rulesets15.png[width=500,align="center"]
...
image::images/rulesets16.png[width=500,align="center"]
...
image::images/rulesets17.png[width=500,align="center"]
...
image::images/rulesets18.png[width=500,align="center"]
...
image::images/rulesets19.png[width=500,align="center"]
...
image::images/rulesets20.png[width=500,align="center"]
...
image::images/rulesets21.png[width=500,align="center"]
...
* *Object* - It needs to match speicific domain External Network object

image::images/rulesets22.png[width=500,align="center"]

== Creating rulesets using apoctl
To create an External Network using apoctl, you will need to create an yaml file with your ruleset configuration and import it to the namespace of interest, using the command below:
