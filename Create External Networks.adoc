...
image::flow_logs_create_external networks.png[width=1000]

Clicking on this button will expand a view that allows you to create an External Network. +

image::flow_logs_create_external_network_suggestion.png[width=400]
