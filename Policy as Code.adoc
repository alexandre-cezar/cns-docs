...
A detailed example of the complete task is provided https://www[here] as a reference
...
** https://www[External Network template]
** https://www[Namespace template]
** https://www[Outgoing ruleset template]
** https://www[Allow-All internal template]

A detailed example of a Jenkinsfile is provided https://www[here] as a reference