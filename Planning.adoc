...
image::images/planning_tags.png[width=1000]
...
image::images/planning_namespace_example.jpeg[width=1200]
...
image::images/planning_flows.png[width=1000]
...
image::images/planning_logs.png[width=1000]
...
image::images/planning_subject.png[width=900]
...
image::images/planning_tenant_policies.jpeg[width=1000]
...
image::images/planning_cloudaccount_policies.jpeg[width=1000]
...
image::images/planning_group_policies.jpeg[width=1000]
...
image::images/planning_k8s_policies.jpeg[width=1000]
...
image::images/planning_flow_monitoring.png[width=1000]

Next step is to inspect the application flows to identify what flows are being rejected and why.

image::images/planning_flow_analysis.png[width=1000]
